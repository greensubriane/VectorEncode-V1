...
private static JFreeChart createCombinedChart() {
    ...
    localXYPlot1.setRangeAxisLocation(BOTTOM_OR_LEFT);
    ...
    localXYPlot2.setRangeAxisLocation(TOP_OR_LEFT);
    ...
    localCombinedDomainXYPlot.setOrientation(VERTICAL);
    JFreeChart localJFreeChart = new JFreeChart("CombinedDomainXYPlotDemo5", DEFAULT_TITLE_FONT, localCombinedDomainXYPlot, true);
...
public static void main(String[] paramArrayOfString) {
    ...
    centerFrameOnScreen(localCombinedXYPlotDemo5);
