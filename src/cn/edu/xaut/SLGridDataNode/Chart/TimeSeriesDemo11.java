...
import static org.jfree.date.SerialDate.addMonths;
...
private static JFreeChart createChart(String paramString, XYDataset paramXYDataset) {
    JFreeChart localJFreeChart = createTimeSeriesChart(paramString, "Date", "Price", paramXYDataset, true, true, false);
    XYPlot localXYPlot = (XYPlot) localJFreeChart.getPlot();
    localXYPlot.setOrientation(VERTICAL);
    XYItemRenderer localXYItemRenderer = localXYPlot.getRenderer();
    localXYItemRenderer.setSeriesPaint(0, blue);
...
public static JPanel createDemoPanel() {
    ...
    SerialDate localSerialDate2 = addMonths(-6, localSerialDate1);
    ...
    SerialDate localSerialDate3 = addMonths(-3, localSerialDate1);
    ...
    SerialDate localSerialDate4 = addMonths(-1, localSerialDate1);
...
public static void main(String[] paramArrayOfString) {
    ...
    centerFrameOnScreen(localTimeSeriesDemo11);
