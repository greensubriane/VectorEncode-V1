...
public class QueryXMLDoc extends JFrame {
...
private void initComponents() {
    ...
    jButton2.addActionListener(new java.awt.event.ActionListener() {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            new cn.edu.xaut.SLGridDataNode.GUI.QueryResult((String) jComboBox1.getSelectedItem(), GetXPathExpr()).setVisible(true);
        }
    });
...
public String GetXPathExpr() {
    return this.jTextField1.getText().toString();
}
