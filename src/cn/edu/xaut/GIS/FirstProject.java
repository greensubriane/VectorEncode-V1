 ...
 * <p> * This code matches these examples:
 * <ul> * <li><a href="http://docs.codehaus.org/display/GEOTDOC/03+First+Project">First Project</a>
 * <li><a href="http://docs.codehaus.org/display/GEOTDOC/04+How+to+Read+a+Shapefile">How to Read a
 * Shapefile</a> * </ul> *  * The code illustrates how to open a shapefile and collect data about the features contained within
 * it. *
 *
 ...
 * </ul>
 *      * @param args     *
 * Optionally, the path and name of the shapefile     *      * @throws java.lang.Exception
...
private static File promptShapeFile(String[] args) {
    ...
    if (args.length > 0) {
        ...
        int rtnVal = JOptionPane.showConfirmDialog(null, "Can't find " + file.getName() + ". Choose another ?", "Input shapefile", JOptionPane.YES_NO_OPTION);
